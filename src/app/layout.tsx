...
// };
export const metadata:Metadata = {
  title: "HomeCene | Premium Home Décor, Mirrors, Vases & Lamps in Dubai – Elevate Your Space",
  description: "Discover Homecene, Dubai’s premier destination for luxury home décor, mirror vases, lamps, and stylish furniture. Transform your space with elegant designs and smart home essentials. Fast delivery across the UAE!",
  icons: [
